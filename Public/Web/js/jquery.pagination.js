 ...
 */
 (function($){
	...
	// Extend jQuery
	$.fn.pagination = function(maxentries, opts, scope){
    ...
    $(".page-btn").one("click",function(){
      ...
      $(".page-go input").val("");
		...
		function selectPage(new_current_page) {
			...
			var continuePropagation = opts.callback(new_current_page, containers,scope);
			return continuePropagation;
		}
		...
		if(opts.load_first_page) {
			opts.callback(current_page, containers,scope);
		}
