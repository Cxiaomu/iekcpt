...
<div class="account-comment-header">
    <div class="header-main user-info"  style="min-width: 1200px;">
        <div class="user-info-main">
            <p style="margin-left: 45px; margin-top: 30px; font-size: 22px;color: rgb(242, 232, 31);font-weight: bold;line-height: 22px;height: 22px;">简历中心</p>
...
<div class="container right-main" style="margin-left: 10px; ">
                ...
                <div class="edit-box">
                    <div class="topjieshao">
                        <div class="resume-avatar">
                            <p></p>
                            <img src="/IEkcpt3.0/IEkcpt3.0/Public/<?php echo ($vo["jianlitp"]); ?>" alt="您没有上传照片！" width="170px" height="170px" style="float: left;margin-right: 35px;">
                            <div class="resume-lines" style="float: left;line-height: 23px; height: 160px;">
                                ...
                                <div class="tend-line clearfix">
                                    <span>出生日期：</span>
                                    <b><label target="_blank"><?php echo ($vo["birthday"]); ?></label></b>
                                </div>
