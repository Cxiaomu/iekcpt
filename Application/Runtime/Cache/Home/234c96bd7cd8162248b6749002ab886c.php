...
<html>
  <head>
    ...
    <![endif]-->
    <link  type="text/css" rel="stylesheet" href="/iekcpt/Public/Web/css/style.css" >
    ...
    <div class="main-content">
      <ul class="project-list clearfix" id="projectList" style="min-height: 650px;">
        <!--<li class="project-item" >
          <div class="top1">
            <h3>
              <a href="" class="project-name" target="_blank" title="IE-科创平台">IE-科创平台</a>
            </h3>
            <p class="oprate-box">
          ...
          <div class="mid">
            ...
            <p class="creater2 ellipsis">
              项目简介：项目简介项目简介项目简介项目<br>
              简介项目简介项目简介项目简介项目简介项目简介<br>
              项目简介项目简介项目简介项目简介项目简介项目<br>
              简介项目简介项目简介项目简介项目简介项目简介<br>
        ...
        <li class="create-project">
          <a href="../post/applypost.html"  style="cursor: pointer;">
            <div class="plus">
              +
            </div>
            <p class="create-p"> 填写简历 </p>
          </a>
        </li>
      </ul>
    </div>
