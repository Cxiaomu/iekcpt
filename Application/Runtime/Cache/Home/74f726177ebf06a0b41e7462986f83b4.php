...
<div class="container right-main"  style="height: 600px;">
    <ul class="side-nav" data-ac="myProjects" style="height: 700px;">
        <li>
    ...
    <div class="main-content clearfix" style="position:relative;" >
        <div class="right-part">
            <div class="edit-box" style="height: 550px; ">
                <label><img src="/IEkcpt3.0/IEkcpt3.0/Public/Web/images/xiaoxi2.png" ></label>
