...
<html>
  ...
  <head>
    ...
    <!--[if lt IE 9]>
      <script type="text/javascript" src="/IEkcpt2.4/Public/Web/js/html5.js" tppabs="Public/Web/js/html5.js">
      </script>
    <![endif]-->
    ...
    <link href="/IEkcpt2.4/Public/Web/css/style.css" type="text/css" rel="stylesheet" />
    <script src="/IEkcpt2.4/Public/Web/js/base.js" type="text/javascript">
    </script>
    <script src="/IEkcpt2.4/Public/Web/js/service.js"  type="text/javascript">
    </script>
    <!--[if lt IE 9]>
      <script type="text/javascript" src="/IEkcpt2.4/Public/Web/js/respond.min.js" tppabs="Public/Web/js/respond.min.js">
      </script>
    <![endif]-->
  </head>
      ...
      <div class="wrap">
        <h1 class="fl">
          <a href="<?php echo U('indexafter/index');?>" class="fl logo">
            <img src="/IEkcpt2.4/Public/Web/images/banner/logo.png" width="154" height="49" />
          </a>
        </h1>
        <div class="fl logo_text">
          <img src="/IEkcpt2.4/Public/Web/images/banner/logo_text.jpg" alt="懂你所需，做你所想" width="163" height="49" />
        </div>
        <div class="fr">
          <div class="top">
            <span class="call">
...
<div class="course-package-info-txt">
      <em></em>
      <p>从起源上看，英语国家的“pedagogy”、法语国家的“pedagogy”和德语国家的“pedagogik”（教育学）均源于希腊的“pedagogue”（教仆）一词，意为照看、管理和教育儿童的方法。19世纪末，英语国家的人们先后用“education”和“pedagogy”。在我国，“教育学”是一个译名，应是从日文转译过来的，时间大约在20世纪初。希腊语的“pedagogue”（教仆）一词，意为照看、管理和教育儿童的方法。教育学独立的标志的出现前后经历了约两百多年的时间。因此，教育学的独立是一个历史过程，而非在一个瞬间完成的。在公元前约403—221年期间的《学记》是世界上最早专门论述教育问题的著作。但是，作为教育科学体系中一门独立的学科，教育学是在总结人类教育实践经验中逐步形成，经过长期积累而发展起来的。</p>
    </div>
    ...
    <div id="playvideo" style="text-align:center;  display: none; margin-top: 20px;">
        ...
        <video width="320" height="240" controls="controls" id="myVideo">
            ...
            <source src="/IEkcpt2.4/Public/Web/video/coursevideo3.mp4" type="video/mp4" />
            <source src="/IEkcpt2.4/Public/Web/video/coursevideo3.ogg" type="video/ogg" />
 ...
 <div class="course-info-lf fl">
  <div class="course-info-lf-a">
               <div class="course-info-pic">
                 <img src="/IEkcpt2.4/Public/<?php echo ($vo["courselogo"]); ?>" onclick="playvideo()">
