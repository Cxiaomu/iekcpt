...
<html>
  ...
  <head>
    ...
    <!--[if lt IE 9]>
      <script type="text/javascript" src="/IEkcpt3.0/Public/Web/js/html5.js" tppabs="Public/Web/js/html5.js">
      </script>
    <![endif]-->
    ...
    <link href="/IEkcpt3.0/Public/Web/css/style.css" type="text/css" rel="stylesheet" />
    <script src="/IEkcpt3.0/Public/Web/js/base.js" type="text/javascript">
    </script>
    <script src="/IEkcpt3.0/Public/Web/js/service.js"  type="text/javascript">
    </script>
    <!--[if lt IE 9]>
      <script type="text/javascript" src="/IEkcpt3.0/Public/Web/js/respond.min.js" tppabs="Public/Web/js/respond.min.js">
      </script>
    <![endif]-->
  </head>
      ...
      <div class="wrap">
        <h1 class="fl">
          <a href="<?php echo U('indexafter/index');?>" class="fl logo">
            <img src="/IEkcpt3.0/Public/Web/images/banner/logo.png" width="154" height="49" />
          </a>
        </h1>
        <div class="fl logo_text">
          <img src="/IEkcpt3.0/Public/Web/images/banner/logo_text.jpg" alt="懂你所需，做你所想" width="163" height="49" />
        </div>
        <div class="fr">
          <div class="top">
            <span class="call">
...
<div class="course-package-info-txt">
      <em></em>
      <p>“法学”这一用语的拉丁文Jurisprudentia ，在公元前3世纪末罗马共和国时代就已经出现，该词表示有系统、有组织的法律知识、法律学问。古罗马法学家曾给“法学”下过一个经典性的定义：“法学是关于神和人的事物的知识；是关于正义和非正义的科学。”德文、法文、英文以及西班牙文等西语语种，都是在Jurisprudentia的基础上，发展出各自指称“法学”的词汇，并且其内容不断丰富，含义日渐深刻。关于法律问题的学问，在中国先秦时期被称为“刑名法术之学”，或者“刑名之学”。据考证，虽然“律学”一词的正式出现，是在魏明帝时国家设立“律博士”以后，但是，自汉代开始就有了“律学”这门学问，主要是对现行律例进行注释。中国古代“法学”一词最早出现于南北朝时代，然而，那时所用的“法学”一词，其含义仍接近于“律学”。中国古代的“法学”一词与来自近现代西方的“法学”概念有着很大区别。
      现代意义上的汉语“法学”一词，最早由日本输入。日本法学家津田真道于1868年首次用来对应翻译英文Jurisprudence,Science of Law以及德文 Rechtswissenschaft等词汇并对之作了详细说明，该词于“戊戌变法”运动前后传入中国。</p>
    </div>
    ...
    <div id="playvideo" style="text-align:center;  display: none; margin-top: 20px;">
        ...
        <video width="320" height="240" controls="controls" id="myVideo">
            ...
            <source src="/IEkcpt3.0/Public/Web/video/coursevideo3.mp4" type="video/mp4" />
            <source src="/IEkcpt3.0/Public/Web/video/coursevideo3.ogg" type="video/ogg" />
 ...
 <div class="course-info-lf fl">
  <div class="course-info-lf-a">
               <div class="course-info-pic">
                 <img src="/IEkcpt3.0/Public/<?php echo ($vo["courselogo"]); ?>" onclick="playvideo()">
