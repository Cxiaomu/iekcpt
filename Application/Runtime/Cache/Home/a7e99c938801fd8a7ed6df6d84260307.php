...
<div class="container right-main" style="height: 700px;">
                ...
                <div class="edit-box">
                    <div class="topjieshao">
                        <div class="resume-avatar">
                            <p></p>
                            <img src="/IEkcpt3.0/IEkcpt3.0/Public/<?php echo ($vo["jianlitp"]); ?>" width="170px" height="170px" style="float: left;margin-right: 35px;">
                            <div class="resume-lines" style="float: left;line-height: 23px; height: 160px;">
                                ...
                                <div class="tend-line clearfix">
                                    <span>出生日期：</span>
                                    <b><a style="text-decoration:none;" href="/zpwebkaifagongchengshi/" target="_blank"><?php echo ($vo["birthday"]); ?></a></b>
                                </div>
