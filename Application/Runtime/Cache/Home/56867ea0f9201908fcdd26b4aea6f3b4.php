...
<head>
    ...
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/iekcpt//iekcpt/Public/Web/js/html5.js">
    </script>
    <![endif]-->
    <link href="/iekcpt/Public/Web/css/index2016.css" type="text/css" rel="stylesheet" />
    <script src="/iekcpt/Public/Web/js/index2016.js" type="text/javascript">
    </script>
    <!--[if lt IE 9]>
...
<div id="section1" init="true" class="section section1">
    <header class="header">
        <div class="wrap">
            <h1 class="fl">
                <a href="indexafter.html" class="fl logo">
...
<div id="section2" init="true" class="section section2">
    <div class="wrap">
        <div class="home_title">
            <a href="<?php echo U('Cases/findcases');?>" target="_blank">
                <img src="/iekcpt/Public/Web/images/banner/t_case.jpg" width="262" height="78" alt="寻找项目" />
            </a>
        </div>
        ...
        <div class="serve_column">
            <ul class="fix">
                <li class="c1">
                    <dl>
                        <dt class="pic">
                            <a target="_blank" href="<?php echo U('Cases/findcases');?>">
                                <img src="/iekcpt/Public/Web/images/ie.jpg" alt="IE科创平台" width="270" height="200" />
                            </a>
                        </dt>
                        <dt class="t">
                            <a href="<?php echo U('Cases/findcases');?>"  target="_blank">
                        ...
                        <dd>
                            ...
                            目前双创已经成为一种潮流，成为一个大众话题
                        </dd>
                        <dd>

                            而作为当代大学生的我们，更应该紧跟潮流,充
                        </dd>
                        <dd>

                            当主力。大学生具有较高层次的知识，是一个知
                        </dd>
                        <dd>
                ...
                <li class="c2">
                    <dl>
                        <dt class="pic">
                            <a target="_blank" href="<?php echo U('Cases/findcases');?>">
                                <img src="/iekcpt/Public/Web/images/dblx.jpg" alt="打包旅行：注入以旅兴农新动能" width="270" height="200" />
                            </a>
                        </dt>
                        <dt class="t">
                            <a href="<?php echo U('Cases/findcases');?>" rel="noFollow" target="_blank">
                                打包旅行：注入以旅兴农新动能
                            </a>
                        </dt>
                        <dd>

                            打包旅行是山东省唯一一家专注近郊游的旅游
                        </dd>
                        <dd>
                ...
                <li class="c3">
                    <dl>
                        <dt class="pic">
                            <a target="_blank" href="<?php echo U('Cases/findcases');?>" >
                                <img src="/iekcpt/Public/Web/images/znlj.jpg" alt="智能垃圾分类可回收系统" width="270" height="200" />
                            </a>
                        </dt>
                        <dt class="t">
                            <a href="<?php echo U('Cases/findcases');?>">
                        ...
                        <dd>
                            ...
                            2017年我国在《生活垃圾分类制度实施方案》中提
                        </dd>
                        <dd>

                            出目标：实行生活垃圾强制分类的的城市2020年
                        </dd>
                        <dd>

                            达到35%。近年来国内在在北京、广州等城市进行
                        </dd>
                        <dd>
                ...
                <li class="c4">
                    <dl>
                        <dt class="pic">
                            <a  target="_blank" href="<?php echo U('Cases/findcases');?>">
                                <img src="/iekcpt/Public/Web/images/hyhyz.jpg" alt="“海洋环游者”环形智能ROV" width="270" height="200" />
                            </a>
                        </dt>“海洋环游者”环形智能ROV
                        <dt class="t">
                            <a href="<?php echo U('Cases/findcases');?>">
...
<div id="section3" init="false" class="section section3">
    ...
    <ul class="portfolio-grid fix">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>" >
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>" >
                <img src="/iekcpt/Public/Web/images/java.jpg" class="cases_img" alt="Java工程师" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>" >
                <img src="/iekcpt/Public/Web/images/rjyf.jpg" class="cases_img" alt="软件研发管理" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>">
                <img src="/iekcpt/Public/Web/images/it.jpg" class="cases_img" alt="IT技术总监" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>"  >
                <img src="/iekcpt/Public/Web/images/ios.jpg"  class="cases_img" alt="IOS开发工程师" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>" >
                <img src="/iekcpt/Public/Web/images/vue.jpg" class="cases_img" alt="VUE前端开发" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>">
                <img src="/iekcpt/Public/Web/images/android.jpg" class="cases_img" alt="Android开发工程师" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
        ...
        <li class="thumbnail" style="display:block;opacity:1;">
            <a class="thumbnail_a" href="<?php echo U('Post/findpost');?>" >
                <img src="/iekcpt/Public/Web/images/dpj.jpg" class="cases_img" alt="单片机工程师" />
                <div class="projectinfo" style="display: none;">
                </div>
            </a>
            <div class="meta">
    ...
    <div class="btn_cases_more">
        <a href="<?php echo U('Post/findpost');?>"  class="btn">
            查看更多
        </a>
    </div>
</div>
...
<div id="section4" init="false" class="section section4">
    <div class="home_news">
        <div class="home_news_title">
            <a href="teacher/index.html"   target="_blank">
                <img src="/iekcpt/Public/Web/images/banner/t_teacher.jpg" alt="优秀课程" width="310" height="71" />
            </a>
        </div>
        ...
        <div class="succeed">
            <div class="succeed_title" style="position: relative; top: 0px;">

                <img src="/iekcpt/Public/Web/images/banner/webdata.jpg" alt="网站数据" width="296" height="74">

            </div>
            <div class="success_text" style="position: relative; left: 0px;">
                专业的网站，提供最准确的数据供用户参考。
                <br>
            </div>
        </div>
        ...
        <div style="text-align: center;" >
            <div id="container" style="height: 600px; width:1200px;display: inline-block;"></div>
                    ...
                    option = {
                        ...
                        dataset: {
                            source: [
                                ...
                                ['人才', 160, 200, 250, 250, 230, 248],
                                ['项目', 300, 320, 340, 370, 360, 373],
                                ['课程', 200, 220, 230, 270, 260, 275],
                                ['岗位', 89, 134, 196, 224, 187, 208]
                            ]
                        },
                        xAxis: {type: 'category'},
                        yAxis: {gridIndex: 0},
