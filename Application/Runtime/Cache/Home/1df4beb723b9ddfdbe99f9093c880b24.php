    ...
    <div class="container right-main">
        ...
        <div class="main-content">
            <ul class="project-list clearfix" id="projectList" style="min-height: 650px;">
                <li class="create-project" style="margin: 10px;">
                    <a href="<?php echo U('Personal/companyreadresume');?>" id="creatNew" style="cursor: pointer;">
                        <div class="plus">
                           <img src="/IEkcpt3.0/IEkcpt3.0/Public/Web/images/companyyoujian.png" width="200px" height="">
                        </div>
                        <p class="create-p"> 收到的简历</p>
                    </a>
                </li>
